...
output_dir = './Outputs_ENS_SPACOZMI/'
...
for i, [x, name, y] in enumerate(data_loader):
    ...
    for k in range(num_iter):
        ...
        for _ in range(SPA_number):
            ...
            out1 = s_model1(utils.COZ(x_neighbor))
            out2 = s_model2(utils.COZ(x_neighbor))
            out3 = s_model3(utils.COZ(x_neighbor))
            out4 = s_model4(utils.COZ(x_neighbor))
